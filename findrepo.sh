...
# Parallel processing can help if one is I/O bound
# and random access to the files is efficient.
# Generally -P is not related to the number of CPUs
# in this use case as I/O bound.
# TODO: maybe support -j to enable this
#num_proc='-P8'
#max_args='-n200'
